...
class LinearNoiseEmbedding(torch.nn.Module):
    def __init__(self, noise_dim=32):
        ...
        self.linear = Linear(noise_dim, noise_dim)
...
class SongUNet(torch.nn.Module):
    def __init__(self,
                 ...
                 # Dimensionality of noise embedding for FGN model.
                 noise_dim=32,
                 ):
    ...
    def forward(self, x, noise_labels=None, class_labels=None, time_labels=None, augment_labels=None):
        # Mapping.
        if self.noise_channels > 0 and noise_labels is not None:
    ...
    def encode(self, x, noise_labels=None, class_labels=None, time_labels=None, augment_labels=None):
        # Mapping.
        if self.noise_channels > 0 and noise_labels is not None:
            emb = self.map_noise(noise_labels)
            emb = emb.reshape(
    ...
    def decode(self, x, skips, noise_labels=None, class_labels=None, time_labels=None, augment_labels=None):
        emb = noise_labels
        # Decoder.
        aux = None
        tmp = None
